...
export default {
     ...
     *@returns axios
     */
    query: function(url, params = {}, tag) {
        var options = this.axiosOptions(url, 'get', params, tag);
     ...
     *@returns axios
     */
    postQuery: function(url, params = {}, tag) {
     ...
     *@returns axios
     */
    pageQuery: function(url, params = {}, pageIndex = 1, pageSize = 10) {
        //分页页码、分页条数
    ...
    postPageQuery: function(url, params = {}, pageIndex = 1, pageSize = 10) {
        //分页页码、分页条数
        params.pageIndex = pageIndex;
        params.pageSize = pageSize;
        var options = this.axiosOptions(url, 'post', params);
        return axios(options);
    },
     ...
     *@returns axios
     */
    post: function(url, params = {}, tag = true) {
        var options = this.axiosOptions(url, 'post', params, tag);
        return axios(options);
    },
    ...
    // jsonp跨域请求
    ajaxQuery: function(url, type='GET', params = {}, callback) {
        let tmp = {
            url: url,
            data: $.param(params),
            cache: false,
    ...
    // 同步GET请求
    syncGetQuery: function(url, params = {}, callback) {
        // $.get(API_BASE_URL+url, callback);
        $.ajax({
