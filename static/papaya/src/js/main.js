...
papaya.Container.changeMPRMouseType = function (mouseType) {
    ...
    var self = papayaContainers[0];
    if (mouseType == 0)
        self.preferences.scrollBehavior = 'Increment Slice';
    if (mouseType == 1)
        self.preferences.scrollBehavior = 'Zoom';
    if (mouseType == 2) {
        //self.preferences.scrollBehavior = 'Drop';
        isDragMode
        keyDownEvent
    }
};
...
papaya.Container.changeMPRDrawType = function (drawType) {
    ...
    var self = papayaContainers[0];
    if (drawType == 0)
        self.viewer.isShiftKeyDown = false;
    if (drawType == 1)
        self.viewer.isShiftKeyDown = true;
