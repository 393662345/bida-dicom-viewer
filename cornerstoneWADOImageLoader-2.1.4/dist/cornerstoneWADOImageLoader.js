/*! cornerstone-wado-image-loader - 2.1.4 - 2019-06-20 | (c) 2016 Chris Hafey | https://github.com/cornerstonejs/cornerstoneWADOImageLoader */
...
function metaDataProvider(type, imageId) {
  ...
  if (type === 'imagePlaneModule') {
    ...
    var imagerPixelSpacing = (0, _getNumberValues2.default)(dataSet, 'x00181164', 2);
    var estimatedRadiographicMagnificationFactor = (0, _getNumberValues2.default)(dataSet, 'x00181114');
    if (pixelSpacing && pixelSpacing.length > 1) {
      rowPixelSpacing = pixelSpacing[0];
      columnPixelSpacing = pixelSpacing[1];
    } else if (imagerPixelSpacing && imagerPixelSpacing.length > 0) {
      var factor = estimatedRadiographicMagnificationFactor || 1;
      rowPixelSpacing = imagerPixelSpacing[0] / factor;
      columnPixelSpacing = imagerPixelSpacing[1] / factor;
    }
